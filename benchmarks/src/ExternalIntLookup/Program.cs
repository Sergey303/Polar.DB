...
const string ExperimentId = "external-int-lookup";
const string ExperimentTitle = "Equal-range lookup by non-unique integer external key.";
...
{
    Directory.CreateDirectory(dir);
    // TODO create EKeyIndex/ESortIndex for repeated integer key; measure GetManyByKey and materialize all rows.
