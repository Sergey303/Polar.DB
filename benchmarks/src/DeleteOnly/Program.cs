...
const string ExperimentId = "delete-only";
const string ExperimentTitle = "Delete rows by primary key only, if supported.";
...
{
    Directory.CreateDirectory(dir);
    // TODO use real logical delete if supported; otherwise return NotSupported, not rebuild-as-delete.
