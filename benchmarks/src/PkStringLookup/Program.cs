...
const string ExperimentId = "pk-string-lookup";
const string ExperimentTitle = "Point lookup by unique string primary key.";
...
{
    Directory.CreateDirectory(dir);
    // TODO create USequence with string key/index; Build() in setup; measure string key lookup; materialize object[] fields.
