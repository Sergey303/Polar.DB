...
const string ExperimentId = "pk-int-lookup";
const string ExperimentTitle = "Point lookup by unique integer primary key.";
...
{
    Directory.CreateDirectory(dir);
    // TODO create USequence with integer key selector; Build() in setup; measure GetByKey(int); materialize object[] fields.
