...
internal sealed record LookupEngineResult(string Engine, string Status, IReadOnlyList<double> SamplesMs,
    long Queries, long Rows, ulong Checksum, long ArtifactBytes,
