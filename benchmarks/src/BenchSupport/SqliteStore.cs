...
internal static class SqliteStore
{
    public static void Create(string db, Row[] rows, bool withIndexes)
    {
        ...
        Exec(connection, "CREATE TABLE rows(id INTEGER PRIMARY KEY, skey TEXT NOT NULL, external_id INTEGER NOT NULL, external_key TEXT NOT NULL, payload TEXT NOT NULL);");
