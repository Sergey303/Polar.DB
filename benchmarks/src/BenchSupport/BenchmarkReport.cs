...
internal static class BenchmarkReport
{
    ...
    private static StringBuilder Header(ExperimentOptions options, BenchmarkRunManifest manifest)
    {
        ...
        builder.AppendLine("<table><tr><th>Engine</th><th>PID</th><th>Captured UTC</th><th>Runtime</th><th>Commit</th><th>Dirty</th></tr>");
    ...
    private static void AppendCommonNotes(StringBuilder builder, BenchmarkRunManifest manifest)
    {
        ...
        builder.AppendLine("<p>Raw per-sample values are retained in JSON and CSV; the HTML contains derived summaries only.</p>");
    }
