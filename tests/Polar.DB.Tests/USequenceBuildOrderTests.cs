...
public class USequenceBuildOrderTests
{
    ...
    public void Build_FlushesSequence_BuildsAndPersistsIndexes_SavesState_And_ReopenRemainsConsistent()
    {
        ...
        var bySample = sequence.GetAllBySample(1, USequenceIntegrationTestHelpers.Row(0, "CLARA", 0))
            .Cast<object[]>().ToArray();
        ...
        var reopenedBySample = reopened.GetAllBySample(1, USequenceIntegrationTestHelpers.Row(0, "CLARA", 0))
            .Cast<object[]>().ToArray();
