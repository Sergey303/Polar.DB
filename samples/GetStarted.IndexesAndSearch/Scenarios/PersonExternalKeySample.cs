...
{
    internal class PersonExternalKeySample : ScenarioBase
    {
        public PersonExternalKeySample()
        : base("ext", nameof(PersonExternalKeySample), "Scenarios/PersonExternalKeySample")
        {
        }
