...
{
    internal sealed class Program6StringIdHalfKeyPagedStorageScenario : ISampleScenario
    {
        public string Id => "gs1-p6";
        public string Title => "Paged storage with string id and half-key index";
        public string SourcePath => "samples/GetStarted1/Program6.cs";
