...
{
    internal sealed class Program5ThreeSequencesPagedFileStoreScenario : ISampleScenario
    {
        public string Id => "gs1-p5";
        public string Title => "Three sequences and manual key/offset index on paged storage";
        public string SourcePath => "samples/GetStarted1/Program5.cs";
