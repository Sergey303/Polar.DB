...
{
    internal sealed class Program7KeyValueStoragePagedStreamsScenario : ISampleScenario
    {
        public string Id => "gs1-p7";
        public string Title => "Key-value storage over paged streams";
        public string SourcePath => "samples/GetStarted1/Program7.cs";
