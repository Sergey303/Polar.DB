...
namespace GetStarted.PagedStorage.Scenarios
{
    ...
    internal sealed class Program9PagedStorageBenchmarksScenario : ISampleScenario
    {
        public string Id => "gs1-p9";
        public string Title => "Paged storage and sequence write benchmarks";
        public string SourcePath => "samples/GetStarted1/Program9.cs";
