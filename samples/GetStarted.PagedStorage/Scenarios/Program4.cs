...
{
    internal sealed class Program4TableAndUniversalIndexPagedStorageScenario : ISampleScenario
    {
        public string Id => "gs1-p4";
        public string Title => "TableView + Universal Index with PagedStorage";
        public string SourcePath => "samples/GetStarted1/Program4.cs";
