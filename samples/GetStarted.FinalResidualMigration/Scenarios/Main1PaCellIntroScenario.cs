...
internal sealed class Main1PaCellIntroScenario : ISampleScenario
{
    public string Id => "main1";
    public string Title => "Базовое знакомство с PTypeRecord и PaCell";
    public string SourcePath => "samples/GetStarted1/Program.cs :: Main1()";
