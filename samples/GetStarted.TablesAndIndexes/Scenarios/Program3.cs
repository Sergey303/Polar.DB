...
namespace GetStarted.TablesAndIndexes.Scenarios
{
    internal sealed class Program3TableAndUniversalIndexScenario : ISampleScenario
    {
        public string Id => "gs1-p3";
        public string Title => "Таблица и Universal Index";
        public string SourcePath => "samples/GetStarted1/Program3.cs";
