...
{
    internal sealed class Program2TableAndSimpleIndexesScenario : ISampleScenario
    {
        public string Id => "gs1-p2";
        public string Title => "Таблица и простые индексы";
        public string SourcePath => "samples/GetStarted1/Program2.cs";
