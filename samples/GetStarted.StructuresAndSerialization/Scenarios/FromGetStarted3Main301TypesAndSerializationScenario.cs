...
internal sealed class FromGetStarted3Main301TypesAndSerializationScenario : ISampleScenario
{
    public string Id => "gs3-301";
    public string Title => "Типы, объектное представление и текстовая сериализация";
    public string SourcePath => "samples/GetStarted3/Main301.cs";
