...
internal sealed class FromGetStarted1Demo102BearingDeletableScenario : ISampleScenario
{
    public string Id => "gs1-d102";
    public string Title => "BearingDeletable + IndexKey32Comp";
    public string SourcePath => "samples/GetStarted1/Demo102BearingSequ.cs";
    ...
    public void Run()
    {
        ...
        {
            Stream fs = File.Open(SamplePaths.File($"d102_{istream}.bin"), FileMode.OpenOrCreate, FileAccess.ReadWrite);
            istream++;
            return fs;
        };
