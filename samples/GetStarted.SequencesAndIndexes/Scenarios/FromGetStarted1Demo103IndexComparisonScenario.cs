...
internal sealed class FromGetStarted1Demo103IndexComparisonScenario : ISampleScenario
{
    public string Id => "gs1-d103";
    public string Title => "Сравнение IndexKey32Comp и IndexView";
    public string SourcePath => "samples/GetStarted1/Demo103Compare.cs";
    ...
    public void Run()
    {
        ...
        int cnt = 0;
        Func<Stream> GenStream = () => new FileStream(SamplePaths.File($"f{cnt++}.bin"),
        ...
        table.Indexes = new IIndex[]
            {
                ...
                new IndexView(GenStream, table, obj => true,
                    comp) { tmpdir = SamplePaths.DataDirectory, volume_of_offset_array = 2_000_000 }
            };
